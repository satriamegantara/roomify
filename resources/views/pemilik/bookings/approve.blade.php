...
<head>
    ...
    <title>Setujui Booking - Roomify</title>
    ...
    <main class="booking-main" style="margin-left:0; padding:2rem;">
        <div class="booking-header" style="margin-bottom:1.5rem;">
            <div class="booking-header-top">
                <div>
                    <h1 class="booking-title"><i class="bi bi-check-circle me-2"></i>Setujui Booking</h1>
                    <p class="booking-subtitle">Konfirmasi persetujuan untuk booking ini.</p>
                </div>
